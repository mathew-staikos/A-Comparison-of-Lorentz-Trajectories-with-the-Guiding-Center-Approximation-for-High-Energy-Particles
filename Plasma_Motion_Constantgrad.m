function Plasma_Motion_Constantgrad
clc
...
%PLOTS
%Plot Trajectory
figure; %figure 5  %SET ISTERMINAL IN EVENTS TO 0 (LINE #)
xlabel('X');
ylabel('Y');
grid on;
axis equal;
...
plot(r_grx,r_gry,'r')
tet2=-0.1:0.1:2*pi;
plot(15+0.3*cos(tet2),25+0.3*sin(tet2),'k' )
plot(15+0.00*cos(tet2),25+0.00*sin(tet2),'k.' )
text(15.3, 25,'{\bf B}')
text(14.5, 15,'{\nabla B}')
text(14.9, 5,'{v_D}')
...
%Plot Gyrocenter Iterations 
figure; %figure 7 8 & 9 FOR 8 & 9 set v0(2)-(LINE 23) to -20 and -30 respecively
xlabel('X');
ylabel('Y');
grid on;
axis equal;
...
Guiding_Center_Iterations_Constantgrad
legend('Trajectory','1st Iteration','Converged Gyrocenter','2nd Iteration','3rd Iteration')

%Plot Gyrocenter Iteration Markers 
%figure 7
Plot_w_Markers_Constantgrad
...
%Magntic Moments
figure; %figure 12 FOR right panel set v0(2)-(LINE 23) to -2.5
...
%figure 16
Overlay_exact_positions_constantgrad
end
